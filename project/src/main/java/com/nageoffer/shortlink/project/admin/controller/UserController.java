...
import com.nageoffer.shortlink.project.admin.dto.resp.UserActualRespDTO;
...
public class UserController {
    ...
    @PutMapping("/api/short-link/admin/v1/user/role")
    public Result<Void> updateRole(@RequestBody UserRoleUpdateReqDTO requestParam) {
        userService.updateRole(requestParam);
        return Results.success();
    }
