...
public class ShortLinkStatsServiceImpl implements ShortLinkStatsService {
    ...
    public ShortLinkStatsRespDTO oneShortLinkStats(ShortLinkStatsReqDTO requestParam) {
        ...
        if (CollUtil.isEmpty(listStatsByShortLink)) {
            bizMetricsKit.increment("shortlink.biz.stats.shortlink.query", "result", "empty");
            return null;
        }
        ...
        bizMetricsKit.increment("shortlink.biz.stats.shortlink.query", "result", "success");
    ...
    public ShortLinkStatsRespDTO groupShortLinkStats(ShortLinkGroupStatsReqDTO requestParam) {
        ...
        if (CollUtil.isEmpty(listStatsByGroup)) {
            bizMetricsKit.increment("shortlink.biz.stats.group.query", "result", "empty");
            return null;
        }
        ...
        bizMetricsKit.increment("shortlink.biz.stats.group.query", "result", "success");
        return ShortLinkStatsRespDTO.builder()
    ...
    public IPage<ShortLinkStatsAccessRecordRespDTO> shortLinkStatsAccessRecord(ShortLinkStatsAccessRecordReqDTO requestParam) {
        ...
        if (CollUtil.isEmpty(linkAccessLogsDOIPage.getRecords())) {
            bizMetricsKit.increment("shortlink.biz.stats.access_record.query", "result", "empty");
            return new Page<>();
        }
        ...
        bizMetricsKit.increment("shortlink.biz.stats.access_record.query", "result", "success");
        return actualResult;
    }
