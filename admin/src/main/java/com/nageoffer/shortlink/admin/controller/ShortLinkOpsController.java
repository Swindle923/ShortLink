...
public class ShortLinkOpsController {
    ...
    public Result<ShortLinkOpsOverviewRespDTO> opsOverview(String gid,
        ...
        return shortLinkActualRemoteService.opsOverview(gid, expiringDays, quotaRiskThreshold);
    }
    ...
    public Result<Page<ShortLinkOpsRiskRespDTO>> opsHighRisk(String gid, Long current, Long size) {
        return shortLinkActualRemoteService.opsHighRisk(gid, current, size);
    }
    ...
    public Result<Page<ShortLinkOpsLifecycleAlertRespDTO>> opsLifecycleAlerts(String gid,
                                                                               ...
                                                                               Long current,
                                                                               Long size) {
        return shortLinkActualRemoteService.opsLifecycleAlerts(gid, expiringDays, quotaRiskThreshold, current, size);
    }
}
